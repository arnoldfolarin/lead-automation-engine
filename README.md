...
AI-powered B2B lead automation platform built solo during a software engineering internship at OutreachPlatform w/ Cursor. The system ingests leads, generates personalized outreach with OpenAI, delivers email through SendGrid, tracks replies, and runs scheduled follow-up sequences. All lead events are logged in Firestore under tenant-scoped paths.
